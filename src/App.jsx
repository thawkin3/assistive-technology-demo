    ...
    <main>
      ...
      <div className="hStack">
        ...
        <button
          className="btn primary"
          type="button"
          onClick={() => alert('clicked button 6!')}
        >
          Button 6
        </button>
      </div>
      ...
      <p className="adjustableFontSize">
        <b>This text will adjust to browser zoom and text zoom.</b>
      </p>
      <p className="adjustableFontSize">
      ...
      <p className="nonAdjustableFontSize">
        <b>This text will adjust to browser zoom but not text zoom.</b>
      </p>
      <p className="nonAdjustableFontSize">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
        quis justo et nisl efficitur tincidunt. Aliquam erat volutpat. Etiam at
